...
<div id="primary">
  <main id="main">
    ...
    <?php while ( have_posts() ) : the_post();
      ...
      <section class="toc pbn section-one gradient secondary-page" style="background: linear-gradient(149.33deg, rgba(9,28,39,0) 0%, rgba(9,28,39,0.65) 100%), linear-gradient(38.4deg, rgba(9,28,39,0) 0%, rgba(9,28,39,0.6) 100%), url(<?php echo $feature_image; ?>) no-repeat; background-position: center center;">
